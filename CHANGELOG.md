...
- **Updated glob** from 11.0.3 to 11.1.0 - Fixes HIGH severity command injection
- **Updated body-parser** from 2.2.0 to 2.2.1 - Fixes MEDIUM severity DoS
- **Updated js-yaml** from 4.1.0 to 4.1.1 - Fixes MEDIUM severity prototype pollution
...
- **Updated @modelcontextprotocol/sdk** from 1.20.2 to 1.25.1
  - Fixes HIGH severity: DNS rebinding protection not enabled by default
...
- **Removed outdated diagnostic test file** - Deleted `callToolHandler.diagnostic.test.ts` which referenced non-existent test tools

### Documentation

- **Added LOG_LEVEL to README** - Documented new logging configuration environment variable (debug/info/warn/error/silent)
